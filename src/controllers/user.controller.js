...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if(!avatarLocalPath){
        throw new ApiError(400, "Avatar filepath is undefined")
    }
...
const chanegCurrentPassword = asyncHandler(async (req, res) => {
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, channel[0], "User chnnel fetched successfully")
    )
